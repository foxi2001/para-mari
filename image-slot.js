...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // Content. Accept data:image/ URLs (canvas drops) and https:// URLs
      // (Supabase Storage public URLs served via /api/slots). The `src`
      // attribute is author-controlled and passes through unchanged.
